...
export const metadata: Metadata = {
  ...
  description: 'Astor is project management software for cabinet, countertop, door, and flooring supplier-installer subs. One source of truth from every job site — so the office can fabricate and dispatch with confidence.',
  ...
  twitter: {
    ...
    title: 'Astor — Source of Truth for Production-Home Subcontractors',
    description: 'Project management for cabinet, countertop, door, and flooring subs on production-builder tracts.',
  },
}
