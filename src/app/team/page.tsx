...
import { EMAIL, CALENDLY_URL, CTA_TEXT } from '@/lib/constants'
            ...
            <div className="md:flex">
              ...
              <div className="md:w-3/5 p-8 md:p-12">
                <div className="inline-flex items-center gap-2 bg-brand-50 border border-brand-200 rounded-full px-3 py-1 mb-4">
                  ...
                  <span className="text-brand-700 text-xs font-semibold">Founder</span>
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid sm:grid-cols-3 gap-6">
            <div className="bg-slate-50 rounded-2xl p-6 text-center">
              ...
              <div className="font-bold text-lg text-slate-900 mb-1">Duke University</div>
              <div className="text-slate-500 text-sm">MBA, Fuqua School of Business</div>
            </div>
            <div className="bg-slate-50 rounded-2xl p-6 text-center">
              <div className="text-3xl mb-3">🤖</div>
              <div className="font-bold text-lg text-slate-900 mb-1">4+ Years in AI</div>
              <div className="text-slate-500 text-sm">Building AI products at Informed.IQ</div>
            </div>
            <div className="bg-slate-50 rounded-2xl p-6 text-center">
              <div className="text-3xl mb-3">📍</div>
              <div className="font-bold text-lg text-slate-900 mb-1">South Florida</div>
