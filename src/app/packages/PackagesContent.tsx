        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-3 gap-6">
            {Object.entries(PACKAGES).map(([key, pkg]) => (
              <div
                key={pkg.name}
                className={`bg-white rounded-2xl p-8 md:p-10 hover:shadow-lg transition-all duration-300 flex flex-col ${
                  key === 'fullFunnel'
              ...
              >
                ...
                <p className="text-slate-500 mb-8">{pkg.tagline}</p>
                ...
                <Link
                  href="/contact"
                  className={`block text-center px-6 py-4 rounded-full font-semibold transition-all duration-300 hover:shadow-md ${
                    key === 'fullFunnel'
                      ? 'bg-brand-600 hover:bg-brand-700 text-white shadow-lg shadow-brand-600/20 hover:shadow-xl'
          ...
          <div className="mt-16 bg-slate-50 border border-slate-100 rounded-2xl p-8 md:p-10 text-center">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto mb-6">
              Astor works on your business every single day — researching best practices, optimizing your ads and content, monitoring competitors, and adapting to every platform change in real time. It never takes PTO. It never forgets about you. And it gets smarter every week.
            </p>
