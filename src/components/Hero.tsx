      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-brand-50 border border-brand-200 rounded-full px-4 py-1.5 mb-8">
            ...
            <span className="text-brand-700 text-sm font-medium">AI-powered marketing for local businesses</span>
          </div>

          <h1 className="text-4xl md:text-6xl lg:text-[4.25rem] font-bold text-slate-900 leading-[1.1] mb-6">
            Your customers are searching.{' '}
            <span className="text-brand-600">Make sure they find you.</span>
          </h1>

          <p className="text-lg md:text-xl text-slate-500 max-w-xl leading-relaxed mb-10">
            We help local businesses show up on Google, get more reviews, and turn clicks into customers — using AI to do it faster and smarter.
          </p>
          ...
          <p className="text-slate-400 text-sm mt-6">
            Free strategy call &middot; No contracts &middot; Results in 90 days
          </p>
        </div>
      </div>
    </section>
